...
namespace NhanVienKyThuat
{
    public partial class frmDienThongTinPhong : Form
    {
        ...
        {
            decimal giathue;
            if (txtDienTich.Text.Trim().Length == 0 || txtGiaThue.Text.Trim().Length == 0 || txtMaPhong.Text.Trim().Length == 0 || txtSoBongDen.Text.Trim().Length == 0 || txtSoMayLanh.Text.Trim().Length == 0 || txtTangLau.Text.Trim().Length == 0 || txtTenPhong.Text.Trim().Length == 0)
